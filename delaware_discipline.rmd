...
```{r}
process_race_data <- function(pop_df, discipline_df, dis_code, race_name, subgroup_query=NULL, grade_query=NULL, gender_query=NULL, disc_type=NULL) {
    ...
    find_num_disc_students <- function(discipline_df, dis_code, race_name = NULL, subgroup_query=NULL, subgroup_query=NULL, grade_query = NULL, gender_query = NULL, disc_type = NULL) {
        filtered <- discipline_df |> 
            filter(district_code == dis_code) 
        ...
        if (is.null(race_name) || tolower(race_name) == "all") {
            ...
            filtered <- filtered |> 
            filter(race == race_name) 
            # This needs to be fixed to allow users to search subgroup
